      ...
      <section className="chartSection">
        ...
        <div className="card">
          ...
          <p style={{ color: 'var(--text-secondary)', marginTop: '0.75rem' }}>
            A estrutura do SignalIndustry está pronta. As séries e análises serão adicionadas na próxima etapa.
          </p>
        </div>
      </section>
    </div>
...
export default SignalIndustryPage
